        ...
        <div className="hero-text">
          ...
          <div className="about-content">
            ...
            <p>
              ...
              with airport <strong className='keywords'> pickups from </strong>Nairobi airport or Mombasa Airport.
            </p>
          </div>
          <Link to='/booking'>
      ...
      <section className="destinations">
        ...
        <div className="destination-cards">
          ...
          <div className="destination-card">
            <img src="/aberadre10.PNG" alt="Aberdare" loading="lazy" />
            <h3>Aberdare</h3>
          ...
          {/* Destination 2 */}
          <div className="destination-card">
            <img src="/masai1.PNG" alt="Maasai Mara" loading="lazy" />
            <h3>Maasai Mara</h3>
          ...
          {/* Destination 3 */}
          <div className="destination-card">
            <img src="/amboseli1.PNG" alt="Amboseli National Park" loading="lazy" />
          ...
          {/* Destination 4 */}
          <div className="destination-card">
            <img src="/mt kenya1.PNG" alt="Mount Kenya" loading="lazy" />
            <h3>Mount Kenya</h3>
          ...
          {/* Destination 5 */}
          <div className="destination-card">
            <img src="/diani1.PNG" alt="Diani Beach" loading="lazy" />
            <h3>Diani Beach</h3>
          ...
          {/* Destination 6 */}
          <div className="destination-card">
            <img src="/chale1.PNG" alt="Chale Highland" loading="lazy" />
          ...
          {/* Destination 7 */}
          <div className="destination-card">
            <img src="/karura1.PNG" alt="Karura Forest" loading="lazy" />
            <h3>Karura Forest</h3>
          ...
          {/* Destination 8 */}
          <div className="destination-card">
            <img src="/hellsgate1.PNG" alt="Hell's Gate National Park" loading="lazy" />
          ...
          {/* Destination 9 */}
          <div className="destination-card">
            <img src="/nakuru1.PNG" alt="Lake Nakuru" loading="lazy" />
            <h3>Lake Nakuru</h3>
          ...
          {/* Destination 10 */}
          <div className="destination-card">
            <img src="/rift valley1.PNG" alt="Great Rift Valley" loading="lazy" />
          ...
          {/* Destination 11 */}
          <div className="destination-card">
            <img src="/samburu1.PNG" alt="Samburu National Park" loading="lazy" />
          ...
          {/* Destination 12 */}
          <div className="destination-card">
            <img src="/tsavo1.PNG" alt="Tsavo National Park" loading="lazy" />
          ...
          {/* Destination 13 */}
          <div className="destination-card">
            <img src="/manda bay1.PNG" alt="Mandabay Beach" loading="lazy" />
          ...
          {/* Destination 14 */}
          <div className="destination-card">
            <img src="/watamu1.PNG" alt="Watamu" loading="lazy" />
            <h3>Watamu</h3>
          ...
          {/* Destination 15 */}
          <div className="destination-card">
            <img src="/fall1.PNG" alt="Thika Falls" loading="lazy" />
            <h3>Thika Falls</h3>
